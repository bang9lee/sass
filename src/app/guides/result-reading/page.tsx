...
import { buildPageMetadata, getResultReadingGuideCopy, resolveSupportedLang } from "@/lib/site-content";
...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
    ...
    return buildPageMetadata(currentLang, getResultReadingGuideCopy(currentLang));
}
