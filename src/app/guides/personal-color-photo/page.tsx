...
import { buildPageMetadata, getPersonalColorGuideCopy, resolveSupportedLang } from "@/lib/site-content";
...
export async function generateMetadata({ searchParams }: Props): Promise<Metadata> {
    ...
    return buildPageMetadata(currentLang, getPersonalColorGuideCopy(currentLang));
}
