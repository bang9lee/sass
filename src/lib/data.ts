...
export const AESTHETICS: Record<AestheticId, Aesthetic> = {
    whimsigoth: {
        ...
        title_ko: '윌지가스',
        title_zh: '梦幻哥特 (Whimsigoth)',
        title_ja: 'ウィムシゴス (Whimsigoth)',
    ...
    clean_girl: {
        ...
        title_ko: '클린걸',
        title_zh: '极简净颜 (Clean Girl)',
        title_ja: 'クリーンガール (Clean Girl)',
    ...
    y2k: {
        ...
        archetype_zh: '迷失的乐观主义者',
        archetype_ja: '失われた楽天家',
