...
魔法やタロットに惹かれるのは、平凡な現実があなたの豊かな想像力には退屈すぎるからでしょう。`,
    ...
    clean_girl: {
        ...
        archetype_zh: '完美主义者',
        archetype_ja: '完璧主義者',
        description: `[Personality Analysis]\nYou are the master of self-control.\nYou hate chaos. You need everything around you to be organized to feel calm.\nYou make hard work look effortless, but we know you work harder than anyone else behind the scenes.\n\n[Why this Result?]\nThe 'Clean Girl' look is the mirror of your tidy mind.\nSlick hair, simple clothes, planned schedule—these are your rituals to keep stress away.\nIn a messy world, your ability to create order is your superpower.\n\n[Style Deep Dive]\nThe Clean Girl aesthetic is the 21st-century evolution of minimalism, popularized by icons like Hailey Bieber and Bella Hadid. It's about looking effortless yet perfectly polished—think dewy skin, slicked-back buns, and gold hoop earrings. It signals a high-functioning life where wellness and efficiency are the ultimate status symbols. Focus on 'no-makeup' makeup and neutral linen fabrics.`,
        description_ko: `[성격 분석]\n당신은 자기관리의 끝판왕이시군요.\n주변이 어지러우면 머릿속까지 복잡해져서, 깔끔하게 정리된 환경에서 안정을 찾습니다.\n겉으로는 여유로워 보이지만, 사실은 물 밑에서 치열하게 발을 젓는 백조처럼 보이지 않는 곳에서 엄청난 노력을 하는 타입이에요.\n\n[왜 이 결과가 나왔을까?]\n클린걸(Clean Girl) 스타일은 당신의 깔끔한 성격을 그대로 보여줍니다.\n단정한 머리와 옷차림, 규칙적인 생활은 당신의 마음을 평온하게 만드는 의식과도 같아요.\n혼란스러운 세상 속에서 흔들리지 않고 나만의 질서를 유지하는 능력, 정말 대단합니다.\n\n[스타일 심층 가이드]\n클린걸 에스테틱은 헤일리 비버나 벨라 하디드에 의해 대중화된 21세기형 미니멀리즘입니다. '꾸안꾸(꾸민 듯 안 꾸민 듯)'의 정점으로, 갓 세수한 듯한 매끈한 피부, 슬릭 번 헤어, 그리고 금색 링 귀걸이가 상징이죠. 이 스타일은 단순한 패션을 넘어 웰빙과 효율적인 삶을 추구하는 라이프스타일을 대변합니다. 베이지나 화이트 톤의 리넨 소재와 투명한 메이크업을 주력으로 활용해 보세요.`,
...
大声を出す必要はありません。あなたの深みは、それだけで十分魅力的です。`,
    ...
    y2k: {
        ...
        archetype_zh: '大明星',
        archetype_ja: 'スター',
        description: `[Personality Analysis]\nYou have "Main Character Energy."\nYou hate being bored and always look for the next excitement.\nYou aren't afraid of attention—you love it. And honestly? You deserve it.\n\n[Why this Result?]\nY2K is the spotlight you were born for.\nBright pinks, sparkles, bold logos—they shout "Look at me!" just like your soul does.\nYour confidence makes people smile. Never dim your light for anyone.\n\n[Style Deep Dive]\nY2K fashion is a techno-optimistic explosion of late 90s and early 2000s maximalism. It represents the excitement of the "new millennium"—think metallic fabrics, baby tees, velour tracksuits, and chunky sneakers. Today, it’s being revived as a rebellion against minimalism. To nail this, embrace bold color combinations, kitschy accessories, and anything that glitters. It's not just a trend; it's a celebration of unapologetic self-expression.`,
        description_ko: `[성격 분석]\n어딜 가나 시선을 끄는 '주인공' 에너지를 타고나셨네요!\n지루한 건 딱 질색이고, 항상 새롭고 짜릿한 걸 찾아다니는 모험가 같아요.\n남의 눈치를 보기보다는 "나 좀 봐! 멋지지 않아?" 하고 당당하게 자신을 드러내는 모습이 정말 매력적이에요.\n\n[왜 이 결과가 나왔을까?]\nY2K는 당신의 넘치는 끼를 발산하기 위한 최고의 무대예요.\n튀는 색감, 반짝이는 액세서리는 당신의 자신감을 그대로 보여주는 도구입니다.\n당신의 밝은 에너지는 주변 사람까지 기분 좋게 만드는 힘이 있어요. 절대 그 빛을 잃지 마세요!\n\n[스타일 심층 가이드]\nY2K 패션은 90년대 말과 2000년대 초반의 낙관주의가 폭발한 맥시멀리즘의 정수입니다. 새로운 밀레니엄에 대한 기대감을 메탈릭 소재, 베이비 티셔츠, 벨루어 트레이닝복, 그리고 청키한 스니커즈로 표현했죠. 최근에는 미니멀리즘에 대한 반항으로 다시 주목받고 있습니다. 과감한 색상 조합과 키치한 액세서리, 반짝이는 모든 것을 즐겨보세요. 이것은 단순한 유행이 아니라, 남의 시선을 두려워하지 않는 당당한 자아 표현의 축제입니다.`,
...
あなたの自信は周りの人を笑顔にします。その輝きを失わないで。`,
    ...
    cottagecore: {
        ...
        archetype_zh: '治愈者',
        archetype_ja: '癒し手',
        description: `[Personality Analysis]\nYou have a gentle and kind heart.\nYou dislike fighting and competition. You dream of a peaceful life where everyone is happy.\nYou feel other people's pain deeply, so sometimes the world feels too heavy for you.\n\n[Why this Result?]\nCottagecore is medicine for your tired soul.\nSunlight, flowers, nature... these things make you feel safe.\nWanting a slow life isn't running away. It's your way of protecting your innocence in a harsh world.\n\n[Style Deep Dive]\nCottagecore is an internet-driven aesthetic that romanticizes rural life and a connection to nature. It values simplicity, sustainability, and traditional crafts. To master this look, choose loose-fitting garments in natural fabrics like cotton and linen, often decorated with floral prints, eyelet lace, or embroidery. Think "prairie" dresses, oversized knits, and straw hats. It's about creating a personal sanctuary that feels disconnected from the digital noise.`,
        description_ko: `[성격 분석]\n마음씨가 정말 따뜻하고 다정한 분이시네요.\n싸우고 경쟁하는 걸 싫어하고, 모두가 평화롭게 지내는 세상을 꿈꾸시죠?\n공감 능력이 너무 좋아서, 남의 아픔까지 내 것처럼 느끼느라 가끔은 세상살이가 버겁기도 할 거예요.\n\n[왜 이 결과가 나왔을까?]\n코티지코어(Cottagecore)는 지친 당신의 마음에 주는 '휴식'입니다.\n따스한 햇살, 예쁜 꽃, 자연... 상상만 해도 마음이 놓이죠?\n당신이 이런 포근함을 찾는 건 도피가 아니에요. 삭막한 세상에서도 순수함과 여유를 잃지 않으려는 본능이랍니다.\n\n[스타일 심층 가이드]\n전원생활의 낭만을 현대적으로 재해석한 코티지코어는 단순함과 자연과의 연결을 최우선으로 합니다. 지속 가능한 패션과 전통 수공예의 가치를 존중하죠. 이 스타일을 완성하려면 면이나 리넨 같은 천연 소재의 넉넉한 옷을 선택해 보세요. 잔꽃무늬(Floral), 아일릿 레이스, 자수 디테일이 들어간 '프레이리(Prairie)' 드레스나 오버사이즈 니트가 대표적입니다. 디지털 소음에서 벗어나 나만의 평화로운 안식처를 패션으로 표현해 보세요.`,
...
スローライフを求めるのは逃げではありません。厳しい世界で純粋さを守るための、あなたなりの方法なのです。`,
    ...
    cyberpunk: {
        ...
        archetype_zh: '反叛者',
        archetype_ja: '反逆者',
        description: `[Personality Analysis]\nYou hate being told "Just do it like everyone else."\nYou question rules that don't make sense.\nYou prefer harsh truths over sweet lies.\n\n[Why this Result?]\nCyberpunk matches your rebellious spirit.\nYou see the cracks in the system that others ignore.\nYour courage to be your real self, even when it's weird or different, is your greatest strength.\n\n[Style Deep Dive]\nCyberpunk, or 'Techwear,' is a futuristic aesthetic inspired by high-tech, low-life themes found in neon-lit dystopian cities. It focuses on utility, functionality, and a survivalist edge. To channel this, prioritize high-performance technical fabrics, modular components, and monochromatic or neon-accented palettes. Look for tactical vests, cargo pants with multiple pockets, and reflective details. It’s an aesthetic that speaks to navigating an increasingly complex and digital world with resilience.`,
        description_ko: `[성격 분석]\n"남들 다 하니까 너도 해"라는 말이 제일 싫으시죠?\n이해 안 가는 규칙은 따르기 싫고, 꼰대 같은 권위에는 본능적으로 반감을 느끼는 '사이다' 성격이에요.\n가식적인 칭찬보다는 차라리 솔직한 비판을 선호하는, 쿨내 진동하는 타입이시군요.\n\n[왜 이 결과가 나왔을까?]\n사이버펑크(Cyberpunk)는 당신의 '삐딱한 시선'과 잘 어울려요.\n당신은 남들이 외면하는 세상의 불편한 진실을 꿰뚫어 보는 눈을 가졌거든요.\n남들과 똑같이 되기를 거부하고 '진짜 나'로 살겠다는 그 용기, 정말 멋집니다.\n\n[스타일 심층 가이드]\n흔히 '테크웨어(Techwear)'와 긴밀하게 연결되는 사이버펑크는 고도의 기술과 혼란스러운 삶이 공존하는 디스토피아적 미래에서 영감을 받습니다. 기능성과 유틸리티, 그리고 생존주의적 감각이 핵심이죠. 이 스타일을 연출하려면 고기능성 기술 소재, 모듈형 포켓, 그리고 무채색 베이스에 네온 컬러 포인트가 들어간 아이템을 선택하세요. 택티컬 베스트, 여러 개의 주머니가 달린 카고 팬츠, 반사경(Reflective) 디테일이 당신의 저항 정신을 잘 표현해줄 것입니다.`,
...
変人扱いされても「本当の自分」でいようとする勇気、それがあなたの最大の武器です。`,
    ...
    old_money: {
        ...
        archetype_zh: '君主',
        archetype_ja: '君主',
        description: `[Personality Analysis]\nYou are steady like a rock.\nYou don't chase fast trends. You like things that are proven and last a long time.\nYou have a quiet confidence that doesn't need to show off.\n\n[Why this Result?]\nOld Money shows your love for "Quality."\nYou know that true luxury comes from good character, not flashy logos.\nIn a world that changes too fast, you stand firm with dignity. That is your power.\n\n[Style Deep Dive]\nOld Money, also known as 'Quiet Luxury,' is an aesthetic centered around the fashion choices of multi-generational wealthy families. It’s characterized by a lack of visible branding and a focus on impeccable tailoring and timeless silhouettes. To achieve this, invest in natural fibers like silk, cashmere, and high-quality cotton. Think polos, cable-knit sweaters, and tailored trousers. It’s about a lifestyle of understated sophistication and effortless poise.`,
        description_ko: `[성격 분석]\n당신은 쉽게 흔들리지 않는 바위 같은 분이군요.\n유행 따라 우르르 몰려다니는 건 좀 가벼워 보인다고 생각하시나요?\n검증되지 않은 모험보다는 확실하고 안정적인 길을 선호하는 신중한 성격입니다.\n\n[왜 이 결과가 나왔을까?]\n올드머니(Old Money) 룩은 당신이 추구하는 '변치 않는 가치'를 보여줍니다.\n시끄럽게 자랑하지 않아도 은은하게 배어 나오는 기품이 있어요.\n세상이 아무리 빠르게 변해도, 당신만은 묵묵히 자신의 자리를 지킬 것 같네요.\n\n[스타일 심층 가이드]\n'조용한 럭셔리'라고도 불리는 올드머니 룩은 대를 이어 내려오는 상류층의 패션을 지향합니다. 로고 노출을 철저히 배제하고, 완벽한 테일러링과 고급스러운 소재(실크, 캐시미어 등)에 집중하는 것이 핵심이죠. 폴로 셔츠, 케이블 니트 세터, 그리고 잘 맞는 슬랙스는 이 스타일의 정석입니다. 유행을 타지 않는 클래식한 실루엣을 통해 시대를 초월한 우아함을 연출해 보세요.`,
...
変化の激しい世界で、威厳を持って立ち続ける。それがあなたの力です。`,
    ...
    coquette: {
        ...
        archetype_zh: '恋人',
        archetype_ja: '愛する者',
        description: `[Personality Analysis]\nYou have so much love to give.\nYou get moved easily by small things, and rejection hurts you deeply.\nBut staying soft in a hard world is brave, not weak.\n\n[Why this Result?]\nCoquette is your way of being loved.\nRibbons and pink aren't just cute; they make you look harmless and sweet.\nYou chose to survival by being adorable. And honestly? It works.\n\n[Style Deep Dive]\nThe Coquette aesthetic is a hyper-feminine blend of Victorian-era romance and 50s-era flirtatiousness. It celebrates the "eternal girlhood" through details like lace, bows, pearls, and pastel palettes. To master this, layer delicate fabrics, use hair ribbons as a signature accessory, and incorporate vintage-inspired lingerie details into outer outfits. Iconic references include Lana Del Rey’s aesthetics and the playful yet romantic atmosphere of 'Marie Antoinette'.`,
        description_ko: `[성격 분석]\n사랑받고 싶은 마음도 크지만, 그만큼 사랑을 줄 줄도 아는 '사랑둥이'시네요.\n작은 일에도 감동하고, 남의 말에 상처도 잘 받지만 그만큼 마음이 순수하다는 뜻이에요.\n차가운 세상에서 다정함을 잃지 않는 것, 그건 정말 대단한 용기랍니다.\n\n[왜 이 결과가 나왔을까?]\n코케트(Coquette)는 당신의 사랑스러움을 극대화하는 무기예요.\n리본, 핑크, 레이스... 이런 것들은 당신을 무해하고 지켜주고 싶은 존재로 보이게 하죠.\n"나를 사랑해줘"라고 말하는 대신, 존재 자체로 사랑받기를 선택한 당신. 삭막한 세상엔 당신 같은 로맨티스트가 꼭 필요해요.\n\n[스타일 심층 가이드]\n코케트 에스테틱은 빅토리아 시대의 로맨티시즘과 50년대의 발랄함을 결합한 하이퍼-페미닌 스타일입니다. 레이스, 리본, 진주, 그리고 파스텔 컬러를 통해 '영원한 소녀다움'을 찬미하죠. 이 스타일을 완성하려면 섬세한 소재를 레이어드하고, 헤어 리본을 포인트로 활용하며, 빈티지한 란제리 디테일을 일상복에 섞어보세요. 라나 델 레이의 음악적 분위기나 영화 '마리 앙투아네트'의 화려한 색감이 좋은 참고가 될 것입니다.`,
