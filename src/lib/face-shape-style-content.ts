...
const STYLE_TARGET_COPY: Record<SupportedLanguage, FaceStyleTargetCopy> = {
    ko: {
        ...
        feminine: {
            label: "여성 스타일",
            description: "얼굴의 곡선을 강조하고 부드러운 볼륨감을 살리는 스타일입니다. 앞머리 디자인, 우아한 웨이브, 그리고 생동감을 더하는 메이크업 포인트를 여성 스타일 기준으로 제안합니다.",
            badge: "여성 스타일 맞춤 추천",
        },
        masculine: {
            label: "남성 스타일",
            description: "골격의 입체감을 살리고 깔끔한 라인을 강조하는 스타일입니다. 신뢰감을 주는 가르마 연출, 선이 고운 짧은 컷, 그리고 깔끔한 그루밍 포인트를 남성 스타일 기준으로 제안합니다.",
            badge: "남성 스타일 맞춤 추천",
        },
        neutral: {
            label: "중성 스타일",
            description: "성별의 경계 없이 누구에게나 잘 어울리는 가장 범용적이고 현대적인 스타일입니다. 얼굴형 본연의 장점을 조화롭게 살리는 내추럴한 추천을 보여줍니다.",
            badge: "유니섹스 스타일 추천",
        },
    },
    en: {
        ...
        feminine: {
            label: "Feminine Style",
            description: "Focuses on enhancing soft facial curves and elegant volume. We provide tailored advice on fringe design, graceful waves, and makeup placement that boosts radiance and a feminine aesthetic.",
            badge: "Feminine Track",
        },
        masculine: {
            label: "Masculine Style",
            description: "Emphasizes structural dimensionality and clean, sharp lines. We suggest professional parting techniques, high-definition short cuts, and grooming tips that project confidence and a masculine aesthetic.",
            badge: "Masculine Track",
        },
        neutral: {
            label: "Neutral Style",
            description: "A versatile and modern approach that transcends gender boundaries. We offer balanced, natural recommendations designed to harmonize with your unique face shape and a unisex aesthetic.",
            badge: "Neutral Track",
        },
    },
    zh: {
